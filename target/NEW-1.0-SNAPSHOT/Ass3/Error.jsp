...
<div class="Main">
    ...
    <div class="mid" style="align-items: center; display: flex; flex-direction: column">
        ...
        <div class="Form">
            <div class="text" style="color: red">Something went wrong with your supply info! <br>Please follow <a href="${pageContext.request.contextPath}/Ass3/Ass3.jsp">this link</a> and try again!</div>
        </div>
    </div>
    <div class="right">
