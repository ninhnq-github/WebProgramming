...
<div class="Main">
    ...
    <div class="mid" style="align-items: center; display: flex; flex-direction: column">
        <div class="title">This is Assignment 4c Form</div>
        <div class="Form">
            <FORM NAME="purchaseform"
                  METHOD=GET
                  ACTION="${pageContext.request.contextPath}/OrderReply">
                Quantity: <INPUT maxlength="4" TYPE="text" SIZE="8" NAME="quantity"/>
                <BR /><BR />
