...
<div class="Main">
    ...
    <div class="mid" style="align-items: center; display: flex; flex-direction: column">
        <div class="title">This is Assignment 3 Form</div>
        <div class="Form">
            <%
            ...
            <div class="text">Thank you for your order of <%=quantity%> widgets, <%=name%>!</div>
            <div class="text">At $<%=pricePerUnit%>, your bill will be $<%=totalCost%>.</div>
            <div class="text">You will shortly receive an email confirmation at <%=email%>.</div>
            <div class="text"><b>Your Order complete at <%=LocalDate.now()%></b></div>
        </div>
    </div>
    <div class="right">
